...
- **Party Game:**  
  The standard, social game mode. Great for friends, families, or small groups - up to 100 players. Included with a Premium account. No seats are required. The game runs automatically: the host can pause it, but has no other control over the pacing.
...
Go to [www.quizwitz.tv](https://www.quizwitz.tv) and enter the code displayed on the game screen. Make sure you can see the game screen, or you might miss essential information.
...
In Party and Conference games, pausing is the only way to interrupt the game - everything else runs automatically. If you want more control, use the **QuizWitz Live** game mode with the Quizmaster App. This gives you full control over the pacing and flow of your quiz.
