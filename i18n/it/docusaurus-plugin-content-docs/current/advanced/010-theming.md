...
:::warning
Creare il tuo tema QuizWitz offre la massima flessibilità, ma è un processo complesso e richiede molto tempo. Nella maggior parte dei casi, ti conviene decisamente personalizzare il nostro [tema Emerald](011-emerald-theme.md), progettato apposta per essere facile da adattare.
:::

I temi QuizWitz vengono creati usando **Adobe Animate**. Puoi scaricare un [modello di tema](https://themes.quizwitz.com/empty/quizwitz-empty-theme.zip) da usare come punto di partenza. Tieni presente che creare temi per QuizWitz è un lavoro minuzioso ed è meglio lasciarlo a designer esperti che conoscono a fondo Adobe Animate.
...
Tutti i design personalizzati devono includere il logo QuizWitz.
...
| Attività: squadre scelte                           | Il nome di un'attività.                                                                     | Schermata di attesa o schermata "sei stato selezionato".           |
| Riscontro                                                          |                                                                                                             |                                                                                    |
...
| Feedback dell'attività                                             | Le squadre selezionate per un'attività.                                                     | Schermata di attesa o corretto/sbagliato.                          |
