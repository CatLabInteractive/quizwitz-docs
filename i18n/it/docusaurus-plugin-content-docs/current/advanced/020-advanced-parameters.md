...
| `focusPositions`         |               /              |            50,100           | Definisce un elenco di posizioni aggiuntive che verranno mostrate nell'app quizmaster                                                                                                                                            |
...
| `monitors`               |               /              |            nl,fr            | Se impostato, nelle partite live verranno creati codici separati per mostrare un "monitor" in quella lingua specifica per i presentatori localizzati.                                                            |
...
| `beacon`                 |               /              |           my-beacn          | Imposta un token beacon di CatLab Remote che può essere usato per collegare automaticamente l'app quizmaster.                                                                                                    |
