...
- **Velkou obrazovku nebo projektor** zobrazující hlavní herní obrazovku — nebo **livestream** dostupný všem hráčům
...
> Pokud tvůj kvíz obsahuje **otázky s otevřenou odpovědí**, budeš potřebovat porotu, která zkontroluje odeslané odpovědi. I když tuto roli může převzít quizmaster s dalším zařízením, doporučujeme určit jednoho nebo více vyhrazených členů poroty, aby se quizmaster mohl soustředit na prezentování.

---

Jakmile máš všechno připravené, pokračuj na další stránku a dozvíš se, jak spustit hru s QuizWitz Live.
