...
Při vytváření kvízu můžeš otevřít panel **Nastavení kvízu** a nastavit globální chování a možnosti prezentace. Tato nastavení platí pro **celý kvíz**.

| ![Otevřít možnosti kvízu](/images/open-quiz-options.png) | ![Možnosti kvízu](/images/quiz-options.png) |
| :------------------------------------------------------: | :-----------------------------------------: |
|             _Otevření panelu možností kvízu_             |          _Přehled nastavení kvízu_          |

---

## 🌐 Jazyky

Vyber jazyk, ve kterém kvíz píšeš. Další překlady můžeš přidat později.

---

## 🎨 Motivy

Vyber vizuální motiv pro svůj kvíz.

- Výchozí motiv je **QuizWitz**
- Tvoje organizace může mít přístup k vlastním motivům
- Motivy ovlivňují pozadí, barvy a rozložení

📘 Další podrobnosti o přizpůsobení vizuálů s tímto motivem najdeš v [dokumentaci k motivu Emerald](../advanced/011-emerald-theme.md).
...
Vygeneruje odkazy pro sdílení nebo kód pro vložení s pokročilými nastaveními hry.
