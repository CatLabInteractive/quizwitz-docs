...
| `focusPositions`         |                /               |            50,100           | Definuj seznam dalších pozic, které se zobrazí v aplikaci quizmaster                                                                                                                                         |
...
| `monitors`               |                /               |            nl,fr            | Pokud je nastaveno, v živých hrách se vytvoří samostatné kódy pro zobrazení „monitoru“ v daném jazyce pro lokalizované moderátory.                                                           |
...
| `beacon`                 |                /               |           my-beacn          | Nastav beacon token CatLab Remote, který můžeš použít k automatickému připojení aplikace quizmaster.                                                                                         |
