...
| `focusPositions`         |               /              |            50,100           | Definieer een lijst met extra posities die in de Quizmaster App worden getoond                                                                                                                                                  |
...
| `monitors`               |               /              |            nl,fr            | Indien ingesteld, worden in live spellen aparte codes aangemaakt om een 'monitor' in die specifieke taal te tonen voor anderstalige quizmasters.                                                                |
...
| `beacon`                 |               /              |           my-beacn          | Stel een CatLab Remote beacon-token in waarmee de Quizmaster App automatisch verbinding kan maken.                                                                                                              |
