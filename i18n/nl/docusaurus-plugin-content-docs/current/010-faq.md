...
- **Party game:**  
  De standaard spelmodus om met vrienden te spelen. Perfect voor vrienden, familie of kleine groepen—tot 100 spelers. Inclusief bij een Premium account. Er zijn geen Seats vereist. Het spel draait automatisch: de host kan het pauzeren, maar heeft geen andere controle over het tempo.
- **Live en Conferentie spelen:**  
  ...
  - **QuizWitz Live is de enige modus waar de quizmeester het tempo van het spel controleert** (via de Quizmaster app). Conferentiespellen, zoals Partyspellen, lopen automatisch uit.
...
In Partij- en conferentiespellen, pauzeren is de enige manier om het spel te onderbreken - al het andere loopt automatisch. Als je meer controle wilt, gebruik dan de **QuizWitz Live** spelmodus met de Quizmaster App. Dit geeft je volledige controle over het tempo en de flow van je quiz.
