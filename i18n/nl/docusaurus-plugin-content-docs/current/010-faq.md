...
- **Party Game:**  
  De standaard, sociale spelmodus. Perfect voor vrienden, familie of kleine groepen—tot 100 spelers. Inclusief bij een Premium account. Er zijn geen Seats vereist. Het spel verloopt automatisch: de host kan het pauzeren, maar heeft verder geen controle over het tempo.
...
QuizWitz is ontworpen als een Party Game om met vrienden, familie of collega's te spelen — in dezelfde ruimte of via een videogesprek. Het is niet mogelijk om mee te doen aan een spel dat gestart is door iemand die je niet kent.
...
In Party Games en Conferentiespellen is pauzeren de enige manier om het spel te onderbreken — al het andere verloopt automatisch. Als je meer controle wilt, gebruik dan de **QuizWitz Live** spelmodus met de Quizmaster App. Dit geeft je volledige controle over het tempo en de flow van je quiz.
