...
- Druk op **Start** in de Quizmaster App
...
Om de vertraging van de stream te compenseren, gebruik je de **spelersinteractievertraging** in de Jury App.
...
6. Druk in de Jury App op de knop **Buzzer** en start de tijdmeting
