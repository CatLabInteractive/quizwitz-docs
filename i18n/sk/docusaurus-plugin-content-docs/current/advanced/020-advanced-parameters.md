...
| `focusPositions`         |                /                |            50,100           | Definuj zoznam ďalších pozícií, ktoré sa zobrazia v Quizmaster App                                                                                                                                              |
...
| `monitors`               |                /                |            nl,fr            | Ak je nastavené, v live hrách sa vytvoria samostatné kódy na zobrazenie 'monitora' v danom jazyku pre lokalizovaných quizmasterov.                                                              |
...
| `beacon`                 |                /                |           my-beacn          | Nastav token CatLab Remote beacon, ktorým sa dá automaticky pripojiť Quizmaster App.                                                                                                            |
