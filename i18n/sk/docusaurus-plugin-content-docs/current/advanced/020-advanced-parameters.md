...
| `focusPositions`         |                /                |            50,100           | Definuj zoznam ďalších pozícií, ktoré sa zobrazia v aplikácii quizmaster                                                                                                                                        |
...
| `monitors`               |                /                |            nl,fr            | Ak je nastavené, v živých hrách sa vytvoria samostatné kódy na zobrazenie „monitora“ v danom jazyku pre lokalizovaných prezentujúcich.                                                          |
...
| `beacon`                 |                /                |           my-beacn          | Nastav beacon token CatLab Remote, ktorý sa dá použiť na automatické pripojenie aplikácie quizmaster.                                                                                           |
