...
- **Por defecto, el feedback de cada pregunta se pospone hasta el final de la ronda,** pero el feedback de cada pregunta se muestra por separado, no agrupado en una sola pantalla.
- Si quieres agrupar todo el feedback en una pantalla al final, puedes habilitarlo en la configuración de la ronda.

---

## ⚙️ Configuración del feedback

- **Por defecto (feedback aplazado):** El feedback de cada pregunta se muestra después de la última pregunta, uno por uno en secuencia.
- **Feedback agrupado:** Si se habilita "Mostrar todo el feedback de las preguntas al final de la ronda" en la configuración de la ronda, todo el feedback se combina en una sola pantalla al final.
- **Forzar resultados después de la pregunta:** Si está habilitado en la configuración de una pregunta, el feedback para esa pregunta siempre se mostrará inmediatamente, sin importar la agrupación de feedback de la ronda.

Consulta las [opciones de ronda](../editor/008-round-options.md) para detalles sobre cómo configurar el tiempo del feedback.
...
Para la configuración de puntuaciones, consulta la [sección de puntuación](../editor/008-round-options.md#scoring).
