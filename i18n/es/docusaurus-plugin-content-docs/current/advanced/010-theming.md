...
When you're ready to test your theme, **zip the contents of your design folder** ( - not the folder itself; when you open the zip, you should see your files, not just a single folder - ) and upload it to our [theme tester](https://themes.quizwitz.com/). Esto te da una vista previa en vivo de cómo se verá tu tema en el juego.
...
| Escenario                                                           | Pantalla de juego                                                                                          | Dispositivo del jugador (tablet/teléfono)             |
| ------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| Pantalla de conexión                                                |                                                                                                            |                                                                          |
| Pantalla de espera                                                  | Logo del quiz. Se muestra mientras el quizmaster está leyendo la pregunta. | Una frase que invita al jugador a escuchar con atención. |
...
| Preguntas                                                           |                                                                                                            |                                                                          |
| Adjunto                                                             | Fullscreen attachment view ( - before/after questions or rounds - ).    | Pantalla de espera.                                      |
...
| Feedback                                                            |                                                                                                            |                                                                          |
| Feedback de la pregunta: opción múltiple            | La pregunta, opciones correctas y distribución de respuestas.                              | Correcto / incorrecto + puntos ganados.                  |
| Feedback de la pregunta: pregunta abierta           | La pregunta, opciones correctas y % de respuestas correctas.                               | Correcto / incorrecto + puntos ganados.                  |
| Feedback de la pregunta: pregunta abierta + adjunto | La pregunta, opciones correctas, distribución de respuestas y un adjunto visual.           | Correcto / incorrecto + puntos ganados.                  |
| Feedback de la pregunta: opción múltiple + adjunto  | La pregunta, opciones correctas, distribución de respuestas y un adjunto visual.           | Correcto / incorrecto + puntos ganados.                  |
| Feedback de la actividad                                            | Los equipos seleccionados para una actividad.                                              | Pantalla de espera o pantalla de correcto/incorrecto.    |
