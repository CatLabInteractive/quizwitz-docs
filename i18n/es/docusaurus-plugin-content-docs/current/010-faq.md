...
- **Juego de fiesta:**  
  El modo social estándar. Ideal para amigos, familiares o grupos pequeños — hasta 100 jugadores. Incluido con una cuenta Premium. No se requieren seats. El juego se ejecuta automáticamente: el anfitrión puede pausarlo, pero no tiene otro control sobre el ritmo.
- **Juegos Live y Conference:**  
  ...
  - **TextWitz Live es el único modo en el que el probador controla el ritmo del juego** (a través de la aplicación del maestro). Juegos de conferencia, como Juegos Pary, ejecutarse automáticamente.
