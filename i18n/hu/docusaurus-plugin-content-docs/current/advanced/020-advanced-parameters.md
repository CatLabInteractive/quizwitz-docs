...
| `focusPositions`         |               /               |            50,100           | Határozz meg további pozíciókat, amelyek megjelennek a Quizmaster appban                                                                                                                                               |
...
| `monitors`               |               /               |            nl,fr            | Ha be van állítva, live játékokban külön kódok jönnek létre, hogy a lokalizált quizmasterek számára az adott nyelven jelenjen meg egy 'monitor'.                                                       |
...
| `beacon`                 |               /               |           my-beacn          | Állíts be egy CatLab Remote beacon tokent, amellyel a Quizmaster app automatikusan csatlakoztatható.                                                                                                   |
