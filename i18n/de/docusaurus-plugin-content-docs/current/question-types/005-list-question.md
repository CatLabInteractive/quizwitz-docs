...
- **Punkte pro Antwort:** Punkte können für jede richtige Antwort vergeben werden oder nur, wenn die Mindestanzahl erreicht wird.
...
- **Zeige Beispiele:** Nutze die Funktion ‚Angegeben‘.
- **Listenvarianten:** Füge gängige Schreibweisen/Varianten hinzu.
- **Verringere Juryarbeit:** Verwende wenn möglich automatische Korrektur.

---

Weitere Informationen findest du unter [Jury-App-Dokumentation](../quizmaster/004-jury-app.md).
