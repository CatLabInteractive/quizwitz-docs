...
- **Partyspiel:**  
  Der Standardspielmodus. Great for friends, families, or small groups - up to 100 players. Inklusive im Premium-Account. Seats sind nicht erforderlich. Das Spiel läuft automatisch: Der Host kann es pausieren, hat aber keine andere Kontrolle über das Tempo.
...
QuizWitz is designed as a Party Game to be played with friends, family, or colleagues - either in the same room or via a video call. Es ist nicht möglich, einem Spiel beizutreten, das von jemandem gestartet wurde, den du nicht kennst.
...
In Party and Conference games, pausing is the only way to interrupt the game - everything else runs automatically. Wenn du mehr Kontrolle möchtest, nutze den Spielmodus **QuizWitz Live** mit der Quizmaster-App. Das gibt dir volle Kontrolle über das Tempo und den Ablauf deines Quiz.
