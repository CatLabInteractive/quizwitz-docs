...
| `focusPositions`         |               /              |            50,100           | Legen Sie eine Liste zusätzlicher Positionen fest, die in der Quizmaster-App angezeigt werden sollen                                                                                                                          |
...
| `beacon`                 |               /              |           my-beacn          | Legen Sie ein CatLab Remote Beacon Token fest, mit dem die Quizmaster App automatisch verbunden werden kann.                                                                                                  |
