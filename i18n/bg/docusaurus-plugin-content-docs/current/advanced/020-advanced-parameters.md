...
| `focusPositions`         |               /              |            50,100           | Дефинирай допълнителни позиции, които се показват в Quizmaster App                                                                                                                                      |
...
| `monitors`               |               /              |            nl,fr            | Ако е зададено, при live игри се създават отделни кодове, за да се покаже 'монитор' на този език за локализирани quizmaster-и.                                                          |
...
| `beacon`                 |               /              |           my-beacn          | Задай токен за CatLab Remote beacon, за да свържеш Quizmaster App автоматично.                                                                                                          |
