...
:::tip
Обичайна практика е графичен дизайнер да нарисува темата, а друг човек да я сглоби в Animate. [Ръководството за дизайн на теми](012-theme-design-guide.md) описва какво трябва да достави дизайнерът за целта.
:::
...
When you're ready to test your theme, **zip the contents of your design folder** ( - not the folder itself; when you open the zip, you should see your files, not just a single folder - ) and upload it to our [theme tester](https://themes.quizwitz.com/). Това ти дава преглед на живо как ще изглежда темата ти в играта.
...
| Етап                                                                       | Екран на играта                                                                                         | Устройство на играча (таблет/телефон)           |
| -------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| Екран за свързване                                                         |                                                                                                         |                                                                    |
| Екран за изчакване                                                         | Лого на куиза. Показва се, докато quizmaster чете въпроса на глас.      | Цитат, който насърчава играча да слуша внимателно. |
...
| Въпроси                                                                    |                                                                                                         |                                                                    |
| Прикачен файл                                                              | Fullscreen attachment view ( - before/after questions or rounds - ). | Екран за изчакване.                                |
