...
In a **Piece of Pie** round, teamwork pays off! Общият брой точки, налични за всеки въпрос, зависи от броя играчи, а след това се разделя между всички играчи (или отбори), които отговорят правилно на въпроса.
