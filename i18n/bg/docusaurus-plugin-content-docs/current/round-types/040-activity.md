...
![Екран на играта за рунд Активност](/images/round-modes/activity-main-screen.png)
...
- **Прикачени файлове:** Добави изображения, аудио или видео, за да обясниш активността или да покажеш примери. Quizmaster може да ги покаже на екрана на играта по време на активността.
