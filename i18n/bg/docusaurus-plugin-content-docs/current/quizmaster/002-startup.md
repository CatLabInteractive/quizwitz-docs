...
- В редактора на куиза кликни върху **„Стартирай QuizWitz Live“**  
  ![Стартиране на QuizWitz PRO](/images/start-quizwitz-pro.png)
...
- Натисни **„Генерирай кодове“**, за да създадеш кодове за достъп  
  ![Quizmaster App - създаване на екипи](/images/quizmaster-app-create-teams.png)
...
- Ще получиш Master, Jury и Regie кодове, плюс един код за игра за играчите.
