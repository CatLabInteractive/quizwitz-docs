...
## 🖥️ Iniciar o QuizWitz Live

Podes iniciar um jogo do QuizWitz Live a partir do editor de quiz ou diretamente a partir da tua coleção de quizzes.

- No editor do quiz, clica em **'Iniciar QuizWitz Live'**  
  ![Start QuizWitz PRO](/images/start-quizwitz-pro.png)

- Na tua coleção, clica no **ícone Live** para iniciar  
  ![Iniciar QuizWitz PRO a partir da tua coleção](/images/start-quizwitz-live.png)
...
- Recomendamos um **tablet ou smartphone** para ter mobilidade, mas um laptop também funciona.  
  ![Ecrã de ligação do QuizWitz PRO](/images/quizwitz-pro-connect-token.png)
...
> - Para retomar, primeiro verifica se o **ecrã do jogo está ativo novamente**
> - Depois, **passa o cursor sobre o ecrã** para revelar o menu inferior e pressiona o **botão de pausa** para continuar

---

## 🎮 Selecionar o teu modo de jogo

Depois de ligares, escolhe entre dois modos de jogo:
...
## 👥 Conduzindo com códigos de equipa

Ao usar **códigos de equipa**, primeiro vais criar as equipas na app Quizmaster:

- Adiciona os nomes das equipas
...
Quando estiveres pronto, clica em **'Carregar quiz'**, espera que os conteúdos sejam carregados e, de seguida, clica em **'Iniciar'** para começar.

![App Quizmaster - obter códigos de equipa](/images/quizmaster-app-create-teams2.png)

---

## 👤 Conduzindo com um Código de jogo partilhado
...
1. Clica em **'Carregar quiz'**
2. Clica em **'Iniciar quiz'** e confirma
3. O Código do Jogo continua visível para quem entrar depois

---

## 🎟️ Ativar Seats

Antes de começares, vais precisar de verificar os teus Seats disponíveis.

- Aparece uma visão geral depois de selecionares o modo de jogo
- Se precisares de mais Seats, ativa-os em [app.quizwitz.com/seats](https://app.quizwitz.com/seats)  
  ![App Quizmaster - ativar Seats](/images/quizmaster-app-seats.png)

---

## ▶️ Iniciar o jogo

Assim que a configuração estiver concluída, pressiona **'Iniciar quiz'** na app Quizmaster para iniciar o jogo.

![App Quizmaster - iniciar quiz](/images/quizmaster-app-start-quiz.png)

Agora estás pronto para divertir o teu público com uma experiência QuizWitz Live sem complicações!
