...
- **Jogos normais (não PRO)** **não** precisam de Seats e são ideais para jogar casualmente com amigos ou família.

---

## 🎮 Seats gratuitos para todos

- Todas as contas incluem **3 Seats gratuitos por jogo**, disponíveis para **todos os utilizadores**, mesmo sem licença PRO.
- Estes Seats permitem-te organizar pequenos quizzes com amigos ou testar o teu conteúdo sem custos.
- Os 3 Seats gratuitos **não contam para o teu total pré-pago ou baseado em licença**.
...
- **PRO-50**: 50 Seats permanentemente ativos
- **PRO-100**: 100 Seats permanentemente ativos
- **PRO-500**: 500 Seats permanentemente ativos
- **PRO-1K**: 1000 Seats permanentemente ativos
- **PRO-2K**: 2000 Seats permanentemente ativos
...
- Os Seats são ativados com **créditos QuizWitz**, que podes comprar antecipadamente.
- Há **descontos por volume** ao comprar créditos em grandes quantidades.
- Cada **licença premium** inclui um **valor em créditos gratuitos**.
...
- Durante esse período, podes:
  ...
  - Organizar **eventos de vários dias** durante um fim de semana

---

## 📉 Preços para grupos grandes

- Os preços dos Seats **diminuem** para números maiores de jogadores, tornando grandes eventos mais acessíveis.

---

## ⚠️ Caso especial: modo whitelabel

- Jogos em **modo whitelabel** precisam de **2 Seats por jogador** em vez de um.

> Exemplo: um jogo whitelabel com 100 jogadores precisa de 200 Seats.
