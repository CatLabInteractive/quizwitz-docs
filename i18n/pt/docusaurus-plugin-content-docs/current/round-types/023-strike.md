...
- Por padrão, há **5 níveis** e cada nível concede **20% de pontos extras** (por exemplo, 100% → 120% → 140%...), mas o número de níveis, a percentagem extra por nível e a quantidade de níveis perdidos por respostas erradas podem ser configurados nas configurações da ronda.
...
Para saber mais sobre configurações de ronda e configuração avançada, consulta [Opções de ronda](../editor/008-round-options.md).
