...
- **Total de pontos = pontos-base × número de jogadores (ou equipas).**
...
Para saber mais sobre configurações e opções de ronda, vê [Opções de ronda](../editor/008-round-options.md).
