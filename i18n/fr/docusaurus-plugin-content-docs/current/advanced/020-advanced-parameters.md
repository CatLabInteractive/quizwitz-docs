...
| `monitors`               |                /                |            nl,fr            | Si défini, dans les jeux en direct, des codes distincts seront créés pour afficher un 'monitor' dans cette langue spécifique pour les quizmasters localisés.                                                       |
...
| `beacon`                 |                /                |           my-beacn          | Définissez un jeton de balises à distance CatLab qui peut être utilisé pour connecter automatiquement l'application Quizmaster.                                                                                    |
