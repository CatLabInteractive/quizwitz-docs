...
When you're ready to test your theme, **zip the contents of your design folder** ( - not the folder itself; when you open the zip, you should see your files, not just a single folder - ) and upload it to our [theme tester](https://themes.quizwitz.com/). Cela vous donne un aperçu en direct de l’apparence de votre thème dans le jeu.
...
| Scène                                                                      | Écran de jeu                                                                                                   | Appareil du joueur (tablette/téléphone)                              |
| -------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| Écran de connexion                                                         |                                                                                                                |                                                                                         |
...
| Intro de la partie                                                         | Animation avant la partie.                                                                     | Écran d’attente.                                                        |
| Intro de la manche                                                         | Animation avant chaque manche.                                                                 | Écran d’attente.                                                        |
| Questions                                                                  |                                                                                                                |                                                                                         |
| Pièce jointe                                                               | Fullscreen attachment view ( - before/after questions or rounds - ).        | Écran d’attente.                                                        |
...
| Feedback                                                                   |                                                                                                                |                                                                                         |
| Feedback sur la question : choix multiple                  | La question, les options correctes, et la répartition des réponses.                            | Correct / faux + points obtenus.                                        |
| Feedback sur la question : question ouverte                | La question, les options correctes, et % de réponses correctes.                                | Correct / faux + points obtenus.                                        |
| Feedback sur la question : question ouverte + pièce jointe | La question, les options correctes, la répartition des réponses, et une pièce jointe visuelle. | Correct / faux + points obtenus.                                        |
| Feedback sur la question : choix multiple + pièce jointe   | La question, les options correctes, la répartition des réponses, et une pièce jointe visuelle. | Correct / faux + points obtenus.                                        |
| Feedback sur l'activité                                                    | Les équipes sélectionnées pour une activité.                                                   | Écran d’attente ou écran correct/faux.                                  |
