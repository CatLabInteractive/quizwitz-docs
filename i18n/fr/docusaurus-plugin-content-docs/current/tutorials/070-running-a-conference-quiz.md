...
title: Exécution d'un quiz de conférence
---
...
## Redémarrage du quiz pour un autre groupe
...
Une fois le quiz rechargé, il se souviendra de votre connexion et passera directement à l'écran de bienvenue. Entrez à nouveau en plein écran en utilisant la barre de contrôle.
...
Une fois que les joueurs que vous voulez sont connectés, appuyez sur **S** sur le clavier.  
Un compte à rebours de 5 secondes commence, puis le quiz démarre automatiquement.
