...
- **Correct/Incorrect :** Marquez une ou plusieurs réponses correctes, selon vos réglages.
- **Feedback :** Les joueurs voient quelle réponse était correcte après avoir répondu. Optionnellement, vous pouvez fournir du feedback supplémentaire ou des explications.
...
Voir [Options de score dans les paramètres de la manche](../editor/008-round-options.md#scoring) pour tous les détails.
...
Voir [rédiger des questions](../editor/005-writing-questions.md) pour une vue d'ensemble des réglages des questions.
