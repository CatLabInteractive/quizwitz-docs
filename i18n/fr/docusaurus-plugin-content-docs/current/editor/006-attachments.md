...
> ⚠️ Pour **publier** un Round-About ou un Quiz, **toutes les pièces jointes doivent avoir une attribution valide** renseignée. Sans cela, votre élément ne peut pas être rendu public.

---

## ✨ Effets des pièces jointes

Certains emplacements de pièces jointes prennent en charge des **effets** pour révéler les visuels de manière plus progressive :
...
> 🎮 **Dans les jeux sans quizmaster (Jeu de groupe, mode conférence, Solo) :** Toutes les pièces jointes dans un emplacement sont affichées **simultanément**.

Les détails sur la temporisation et le comportement de chaque emplacement se trouvent dans la documentation liée pour [questions](../editor/015-importing-questions.md), [manches](../editor/008-round-options.md) et [quiz](../editor/007-quiz-options.md).
