...
Lorsque vous utilisez les modes de jeu **QuizWitz Live** ou **Conference** (qui nécessitent des seats), vous recevrez un e-mail avec un lien vers un rapport contenant toutes les réponses données par les joueurs. Nous ne fournissons pas de rapport pour les Jeux de groupe.

---

## Quelle est la différence entre un compte Premium, un Jeu de groupe, et les parties Live/Conference ?

- **Compte Premium :**  
  Déverrouille toutes les fonctionnalités du quizmaker (y compris la création et la modification de quizzes, les options avancées des manches, les pièces jointes, et plus). Premium vous permet également d'organiser des **Jeux de groupe** avec jusqu'à 100 joueurs.
- **Jeu de groupe :**  \nLe mode standard de jeu social. Idéal pour les amis, la famille ou les petits groupes — jusqu'à 100 joueurs. Inclus avec un compte Premium. Aucun seat n'est requis. Le jeu s'exécute automatiquement : l'hôte peut le mettre en pause, mais n'a pas d'autre contrôle sur le rythme.
- **Jeux Live et Conference :**  
  ...
  - Ces modes débloquent des fonctionnalités telles que la Quizmaster App, l'app du jury, des rapports détaillés et plus encore.
  - **QuizWitz Live est le seul mode où le quizmaster contrôle le rythme du jeu** (via la Quizmaster App). Les jeux de conférence, comme les Jeux de groupe, s'exécutent automatiquement.
...
- Dans les Jeux de groupe, les joueurs peuvent choisir leur nom en enregistrant un compte QuizWitz sur leur propre smartphone (ils peuvent également changer leur photo de profil).
...
Allez sur [www.quizwitz.tv](https://www.quizwitz.tv) et entrez le code affiché sur l'écran de jeu. Assurez-vous que vous pouvez voir l'écran de jeu, ou vous pourriez manquer des informations essentielles.

---

## Comment jouer à une partie avec mes amis ?

QuizWitz est conçu comme un Jeu de groupe qui sera joué avec des amis, la famille ou des collègues — soit dans la même pièce, soit par appel vidéo. Il n'est pas possible de rejoindre une partie lancée par quelqu'un que vous ne connaissez pas.

Pour rejoindre une partie, allez sur [www.quizwitz.tv](https://www.quizwitz.tv) et entrez le code que vous voyez sur l'écran de jeu.
...
Dans les parties de type Jeu de groupe ou mode conférence, la mise en pause est le seul moyen d'interrompre la partie — tout le reste se déroule automatiquement. Si vous voulez plus de contrôle, utilisez le mode de jeu **QuizWitz Live** avec la Quizmaster App. Cela vous donne un contrôle total sur le rythme et le déroulement de votre quiz.

Découvrez la Quizmaster App [ici](quizmaster/001-introduction.md).
