...
- **Party game :**  
  Le mode de jeu social standard. Idéal pour les amis, la famille ou les petits groupes — jusqu'à 100 joueurs. Inclus avec un compte Premium. Aucun seat n'est requis. Le jeu s'exécute automatiquement : l'hôte peut le mettre en pause, mais n'a pas d'autre contrôle sur le rythme.
